...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xquery31">
    <sch:pattern>
        <sch:rule context="//div">
            <sch:assert id="a1" role="warn" test="not(section)">A section inside a div is usually superfluous</sch:assert>
    ...
    <sch:pattern>
        ...
        <sch:rule context="article" id="ru3" role="warn"><!-- not "//article" because article is outermost element -->
