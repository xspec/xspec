...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
  ...
  <xsl:template name="paramTemplate03">
    ...
    <xsl:param name="templateParam03-cond1">999<xsl:if test="1 eq 1">999</xsl:if></xsl:param> <!-- Expected miss for xsl:if, Expected unknown for 999 -->
    <xsl:param name="templateParam03-cond2">999<xsl:if test="1 eq 2">999</xsl:if></xsl:param> <!-- Expected miss for xsl:if, Expected unknown for 999 -->
    <node type="param - template">
  ...
  <xsl:template name="paramTemplate07">
    <xsl:param name="templateParam07-no-el1">1000<!--abc-->1000<!--abc--></xsl:param> <!-- Expected unknown for 2nd 1000 -->
    <xsl:param name="templateParam07-no-el2"><!--abc-->1000<!--abc-->1000</xsl:param> <!-- Expected unknown for 2nd 1000 -->
    ...
    <xsl:param name="templateParam07-cond1">1000<xsl:if test="1 eq 1">1000</xsl:if></xsl:param>
    <xsl:param name="templateParam07-cond2">1000<xsl:if test="1 eq 2">1000</xsl:if></xsl:param> <!-- Expected unknown for 2nd 1000 -->
  ...
  <xsl:template name="paramTemplate08">
    <xsl:param name="templateParam08-no-el1"
      as="node()+">1100<!--abc-->1100<!--abc--></xsl:param>                    <!-- Expected unknown for second 1100 -->
    <xsl:param name="templateParam08-no-el2"
      as="node()+"><!--abc-->1100<!--abc-->1100</xsl:param>                    <!-- Expected unknown for second 1100 -->
    ...
    <xsl:param name="templateParam08-cond1"
      as="node()+">1100<xsl:if test="1 eq 1">1100</xsl:if></xsl:param>
    <xsl:param name="templateParam08-cond2"
      as="node()+">1100<xsl:if test="1 eq 2">1100</xsl:if></xsl:param>         <!-- Expected unknown for second 1100 -->
